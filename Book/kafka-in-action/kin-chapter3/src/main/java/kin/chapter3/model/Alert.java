...
public class Alert extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** The allowed values that our sensors will use to emit current status */
   private kin.chapter3.model.AlertStatus status;
   ...
   */
  public Alert(java.lang.Long sensor_id, java.lang.Long time, kin.chapter3.model.AlertStatus status) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: status = (kin.chapter3.model.AlertStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public kin.chapter3.model.AlertStatus getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(kin.chapter3.model.AlertStatus value) {
    this.status = value;
  }
   ...
   */
  public static kin.chapter3.model.Alert.Builder newBuilder() {
    return new kin.chapter3.model.Alert.Builder();
  }
   ...
   * @return A new Alert RecordBuilder
   */
  public static kin.chapter3.model.Alert.Builder newBuilder(kin.chapter3.model.Alert.Builder other) {
    if (other == null) {
      return new kin.chapter3.model.Alert.Builder();
    } else {
      return new kin.chapter3.model.Alert.Builder(other);
    }
  }
   ...
   * @return A new Alert RecordBuilder
   */
  public static kin.chapter3.model.Alert.Builder newBuilder(kin.chapter3.model.Alert other) {
    if (other == null) {
      return new kin.chapter3.model.Alert.Builder();
    } else {
      return new kin.chapter3.model.Alert.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Alert>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(kin.chapter3.model.Alert.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(kin.chapter3.model.Alert other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.sensor_id)) {
        this.sensor_id = data().deepCopy(fields()[0].schema(), other.sensor_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public kin.chapter3.model.Alert.Builder setSensorId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kin.chapter3.model.Alert.Builder clearSensorId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public kin.chapter3.model.Alert.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kin.chapter3.model.Alert.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public kin.chapter3.model.Alert.Builder setStatus(kin.chapter3.model.AlertStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kin.chapter3.model.Alert.Builder clearStatus() {
      status = null;
    ...
    public Alert build() {
      try {
        ...
        record.status = fieldSetFlags()[2] ? this.status : (kin.chapter3.model.AlertStatus) defaultValue(fields()[2]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.status = kin.chapter3.model.AlertStatus.values()[in.readEnum()];
