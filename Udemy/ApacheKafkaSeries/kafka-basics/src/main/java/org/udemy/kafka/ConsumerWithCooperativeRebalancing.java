...
public class ConsumerWithCooperativeRebalancing {
    private static final Logger logger = LoggerFactory.getLogger(ConsumerWithCooperativeRebalancing.class.getSimpleName());
